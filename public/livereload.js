%script
  window.LiveReloadOptions = { host: 'localhost' , port: '35729', mindelay: 1000000};
%script{src: "/hotswap.js"}
...
(function() {
  ...
  exports.Reloader = Reloader = (function() {
    ...
    Reloader.prototype.reloadPage = function(path) {
      if( path.indexOf("asset") < 0) return "Not asset";
      var parts = path.split("/");
      var file = parts[parts.length - 1 ];
      this.window.hotswap._recreate(file.split(".")[1],[file.split(".")[0]],true,0,true);
